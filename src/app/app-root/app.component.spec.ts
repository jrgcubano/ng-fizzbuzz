  ...
  describe('AppComponent', () => {
    ...
    it('should have a toolbar title when rendered', fakeAsync(() => {
      create_app_component().then((app_component) => {
        ...
        expect(title).toEqual('FizzBuzz Kata with Angular');
      });
    }));
    ...
    function create_app_component(): Promise<any> {
      return new Promise<any>((resolve) => {
        ...
        }).overrideTemplate(MatToolbar, '<div><ng-content></ng-content></div>'
          ).compileComponents().then(() => {
            const app_component = TestBed.createComponent(AppComponent);
            resolve({
              get_toolbar_title: () => {
                app_component.detectChanges();
                const content = app_component.debugElement
                  .query(By.css('mat-toolbar')).nativeElement
                  .textContent;
                return content;
              },
              get_fizz_buzz: () => {
